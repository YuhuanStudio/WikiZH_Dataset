...
- [yuhuanstudio/wikipedia-image-zh-tw](https://huggingface.co/datasets/yuhuanstudio/wikipedia-image-zh-tw) - 台灣正體中文維基百科圖像資料（528K 條目）
...
- `tag` (string)：原始維基語法標註，包含圖片顯示方式、尺寸、說明等設定
