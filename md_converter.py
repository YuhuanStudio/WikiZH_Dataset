"""
維基百科數據解析並生成文檔模組
功能：解析維基百科數據並生成 Markdown 或純文本文件
"""

import os
from tqdm import tqdm
from wiki_parser import WIKIParse
...
class WIKIParse2Doc(WIKIParse):
    ...
    def __to_doc(self, ID, text):
        ...
        text_file = ID + '.md' if self.markdown else ID + '.txt'
